...
→ *possibilité de rajouter des données jusqu'en décembre 2022 pour salinité + température (voire script "SOMLIT_2022")*  
...
## Cross interpolations of 5 sites atmospheric pCO~2~ data  
  
### Cross interpolation between Corsica and Haute Provence datasets :  
  

```{r Cross interpolations of Corsica-Haute Provence, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6,fig.height=4,fig.align='center'}
...
```{r Cross interpolations of Corsica-Haute Provence and Monte CImone, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6,fig.height=4,fig.align='center'}
...
```{r Cross interpolations of Corsica-Haute Provence-Monte CImone and Plateau Rosa, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6,fig.height=4,fig.align='center'}
...
```{r Cross interpolations of Corsica-Haute Provence-Monte CImone-Plateau Rosa and Lampedusa, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6,fig.height=4,fig.align='center'}
...
## Visualisation of atmospheric pCO~2~ cross-interpolated (5 sites) + missing values  
  

```{r Visualisation of atmospheric pCO2 cross-interpolated (5 sites), echo=FALSE, warning=FALSE, message=FALSE, fig.width=6,fig.height=4, fig.align='right', fig.show='hold'}
...
#### Table comparing the results of the 2 CO~2~ flux calculation methods

```{r 2 methods comparison, echo=FALSE, warning=FALSE, message=FALSE}

comparison_flux_table <- data.frame(DATA$datetime, DATA$Flux_wan_92, DATA$Flux_wan_2014)

comparison_flux_table <- comparison_flux_table %>% 
  mutate(delta = DATA$Flux_wan_92 - DATA$Flux_wan_2014)

colnames(comparison_flux_table) <- c("Datetime", "Flux_CO2_92", "Flux_CO2_2014", "Delta")
