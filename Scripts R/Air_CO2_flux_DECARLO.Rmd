...
# **Air--Sea CO~2~ Flux (2007-2022) -- Article DE CARLO**
...
Nb_by_month %>% 
  ...
  ggtitle("Evolution of number of observations by month at Point P (2007-2022)")
...
##### Salinity (78 NA) & Temperature (84 NA) :  
...
```{r calcul Flux Wanninkhof (1992), warning=FALSE, message=FALSE}
