...
```{r trend analysis AOU - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4}
...
#plot_grid( plot_AOU_rap1, plot_AOU_rap, ncol=1)
...
```{r plot mean annual O2, O2 sat & AOU monthly means - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=5}
