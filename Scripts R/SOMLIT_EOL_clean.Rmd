...
T_interpol_surf <- na_interpolation(SOMLIT_oxy_surf$T, option="linear")
S_interpol_surf <- na_interpolation(SOMLIT_oxy_surf$S, option="linear")
O_interpol_surf <- na_interpolation(SOMLIT_oxy_surf$O, option="linear")

#interpolation 50m :
T_interpol_prof <- na_interpolation(SOMLIT_oxy_prof$T, option="linear")
S_interpol_prof <- na_interpolation(SOMLIT_oxy_prof$S, option="linear")
O_interpol_prof <- na_interpolation(SOMLIT_oxy_prof$O, option="linear")
##
