...
# ### MONTE CIMONE
# atmospheric_co2_MONTE_CIMONE <- read_delim("../Data/atmospheric_pco2_icos/atmospheric_co2_MONTE_CIMONE_fev_2011_2022.CO2", 
...
#save :
#write.table(pCO2_atmos, "DATA_pCO2_atmos_06-22.csv", sep=";", col.names = TRUE, row.names = FALSE)

```
  
  

## Visualisation 5 sites atmospheric pCO~2~ (µatm)  
  

```{r Visualisation 5 sites atmospheric pCO2, echo=FALSE, warning=FALSE, message=FALSE, fig.width=9,fig.height=4}

pCO2_atmos <- read_delim("../../Data/atmospheric_pco2_icos/DATA_pCO2_atmos_06-22.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
...
corse_HP[4798: 11260,] %>% 
  ...
  annotate(geom="text", x=420, y=430, label="slope : 0.73 ± 0.01 *  R-adj : 0.73", color="black")
...
corse_PR %>% 
  ...
  annotate(geom="text", x=390, y=420, label="slope : 0.99 ± 0.01 *  R-adj : 0.84", color="black")
...
corse_LAMP %>% 
  ...
  annotate(geom="text", x=390, y=420, label="slope : 0.99 ± 0.009 *  R-adj : 0.86", color="black")
...
PR_LAMP %>% 
  ...
  annotate(geom="text", x=390, y=420, label="slope : 0.98 ± 0.005 *  R-adj : 0.93", color="black")
