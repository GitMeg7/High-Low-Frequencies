...
```{r Point B - period 1995-2022 - surface - temp, echo=FALSE, warning=FALSE, message=FALSE}
...
ts_temp_decomp_9522_surf <- decompose(ts_temp_9522_surf, type = "multiplicative") 
...
ts_temp_decomp_9522_prof <- decompose(ts_temp_9522_prof, type = "multiplicative") 
...
seasonal_slopes_temp_surf_9522 <- as.data.frame(FFtemp_9522$seasonal.estimates) %>% 
  dplyr::select(slope) %>% 
