...
ggplot_na_imputations(SOMLIT_pcO2$temperature, SOMLIT_pcO2$impute_temp, x_axis_labels = SOMLIT_pcO2$datetime, xlab = "", ylab="Temp. (°C)", title="Point B - Temperature time series (°C) - period 2007-2022")
...
```{r importation pCO2 air, echo=FALSE, warning=FALSE, message=FALSE}

# pCO2_air <- read_delim("../Data/DATA_pCO2_atmos_06-22.csv", 
#     delim = ";", escape_double = FALSE, trim_ws = TRUE) %>% 
