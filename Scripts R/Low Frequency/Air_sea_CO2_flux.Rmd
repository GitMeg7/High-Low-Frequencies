...
```{r NpCO2 & TpCO2 & deltas calculations, echo=FALSE, warning=FALSE, message=FALSE, fig.width=9,fig.height=6}
...
pco2_bio_plot_rapport <- pco2_bio %>% 
  ggplot() +
  geom_line(aes(x=datetime, y=delta_pCO2_T), col = "#BF3030", size = 0.4) +
  geom_line(aes(x=datetime, y=delta_pCO2_bio), col = "#096A09", size = 0.6) +
  scale_y_continuous(name="ΔpCO2 (µatm)") + 
  scale_x_date(name="", date_breaks="2 year", date_minor_breaks="1 years", labels = date_format("%Y")) +
