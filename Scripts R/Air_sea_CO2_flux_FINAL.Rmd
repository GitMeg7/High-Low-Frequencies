...
#save merge3 :
#write.table(merge3, "DATA_SOMLIT_07-23_impute_0m.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
#save merge3 :
#write.table(merge3, "DATA_SOMLIT_07-23_impute_0m_deltas_pCO2.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
## save flux
#write.table(tab_flux, "DATA_SOMLIT_07-23_impute_0m_deltas_pCO2_and_fluxes_CO2.csv", sep=";", col.names = TRUE, row.names = FALSE)
