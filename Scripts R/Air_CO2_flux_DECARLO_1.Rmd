...
corse_PR_long %>% 
  ggplot() +
  ggtitle("Atmospheric pCO2 of Corsica and Plateau Rosa sites (ICOS) according to time") +
  geom_point(aes(x=datetime, y=value, color= Legend), size=0.5) +
  scale_y_continuous(name="Atmospheric pCO2 (µatm)") + 
  scale_x_datetime(name="")
##
...
corse_PR %>% 
  ...
  scale_y_continuous(name="Corsica") +
  ggtitle("Relationship between Corsica and Plateau Rosa sites for pCO2 atmospheric measurements (µatm)")
...
corse_LAMP_long %>% 
  ggplot() +
  ggtitle("Atmospheric pCO2 of Corsica and Lampedusa sites (ICOS) according to time") +
  geom_point(aes(x=datetime, y=value, color= Legend), size=0.5) +
  scale_y_continuous(name="Atmospheric pCO2 (µatm)") + 
  scale_x_datetime(name="")
##
...
corse_LAMP %>% 
  ...
  scale_y_continuous(name="Corsica") +
  ggtitle("Relationship between Corsica and Lampedusa sites for pCO2 atmospheric measurements (µatm)")
