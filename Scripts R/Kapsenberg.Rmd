...
data_0715_50m <- data_raw_prof %>% filter(sampling_date < "2016-01-05") #462 valeurs
...
Comparaison supplement, Tab S1 (Kapsenberg) Même période : résultats ok

*(Rajouter les SD)*

```{r Calcul monthly means 0715_surface, echo=FALSE, warning=FALSE, message=FALSE}
...
Comparaison Table 2 (Kapsenberg) Même période : résultats ok
...
```{r, plot anomalies temperature 1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
# Plot anomalies
#Anomalies 0 m
...
plot_temp_0715 <- data_0715 %>% 
  ...
  ggtitle("Time series observations of temperature (°C) 2007-2015")
...
```{r, plot anomalies salinity 1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
plot_sal_0715 <- data_0715 %>% 
  ...
  ggtitle("Time series observations of salinity 2007-2015")
...
```{r, plot anomalies pH 1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
plot_ph_0715 <- data_0715 %>% 
  ...
  ggtitle("Time series observations of pH (2007-2015)")
...
```{r, plot anomalies CO2 1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r Calcul monthly means 0715_50m, echo=FALSE, warning=FALSE, message=FALSE}
...
Comparaison Table 2 (Kapsenberg) Même période : résultats ok sauf pour la pCO2
...
```{r, plot anomalies temperature 1 - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
# Plot anomalies
#Anomalies 50 m
...
```{r, plot anomalies salinity 1 - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r, plot anomalies pH 1 - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r, plot anomalies CO2 1 - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r calculate monthly means 2007-2022_surface, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies salinity - surface, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
plot_sal_0722 <- data_0722 %>% 
  ...
  scale_x_datetime(name="") +
  scale_y_continuous(name="Salinity") +
  ggtitle("Time series observations of salinity (2007-2022)")
...
```{r, plot anomalies pH - surface, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
plot_ph_0722 <- data_0722 %>% 
  ...
  scale_x_datetime(name="") +
  scale_y_continuous(name="pH") +
  ggtitle("Time series observations of pH (2007-2022)")
...
```{r, plot anomalies CO2 - surface, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
plot_pCO2_0722 <- data_0722 %>% 
  ...
  scale_x_datetime(name="") +
  scale_y_continuous(name="pCO2 (uatm)") +
  ggtitle("Time series observations of pCO2 (2007-2022)")
...
#### Table of monthly means (2007-2022) _ 50m data
...
```{r, plot anomalies temperature - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r, plot anomalies salinity - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r, plot anomalies pH - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
...
```{r, plot anomalies CO2 - 50m, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8,fig.height=4,fig.align='center'}
