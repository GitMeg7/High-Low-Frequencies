...
```{r periode 2007-2015 (Kapsenberg), echo=FALSE, warning=FALSE, message=FALSE}
# Calculate anomalies
# Surface
...
```{r, plot anomalies temperature 1, echo=FALSE, warning=FALSE, message=FALSE}
# Plot anomalies
#Anomalies 0 m
...
```{r, plot anomalies salinity 1, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies pH 1, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies CO2 1, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, mm technique pour 2007-2022, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies temperature, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies salinity, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies pH, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, plot anomalies CO2, echo=FALSE, warning=FALSE, message=FALSE}
